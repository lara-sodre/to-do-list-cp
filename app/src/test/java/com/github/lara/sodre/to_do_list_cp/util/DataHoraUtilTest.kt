package com.github.lara.sodre.to_do_list_cp.util


import com.github.lara.sodre.to_do_list_cp.ui.combinarDataHora
import com.github.lara.sodre.to_do_list_cp.ui.extrairDataDoDatePicker
import com.github.lara.sodre.to_do_list_cp.ui.formatarDataHora
import com.github.lara.sodre.to_do_list_cp.ui.paraMillisUtcDoDatePicker
...
class DataHoraUtilTest {
    ...
    fun combinarDataHoraGeraTimestampComComponentesCorretos() {
        val resultado =
            combinarDataHora(ano = 2026, mes = Calendar.JULY, dia = 15, hora = 14, minuto = 30)
